...
function Curtains(t) {
  ...
  (this.shaderPasses = []),
  (this._drawStacks = {
    opaque: { length: 0, programs: [] },
    transparent: { length: 0, programs: [] }
  }),
...
(Curtains.prototype._init = function() {
  ...
  (Curtains.prototype.updateScrollValues = function(t, e) {
    ...
    (this._scrollManager.yOffset = e),
      (this._scrollManager.lastYDelta = r - this._scrollManager.yOffset);
  }),
  ...
  (Curtains.prototype._contextLost = function(t) {
    t.preventDefault(),
      (this._drawStateManager = { currentProgramID: null, programs: [] }),
  ...
  (Curtains.prototype._contextRestored = function() {
    ...
    for (t = 0; t < this.shaderPasses.length; t++)
  ...
  (Curtains.prototype.dispose = function() {
    ...
    this._shaders && (this._shaders = null);
    for (var t = 0; t < this._drawStateManager.programs.length; t++) {
      var e = this._drawStateManager.programs[t];
      this.glContext.deleteShader(e.fragmentShader),
        this.glContext.deleteShader(e.vertexShader),
        this.glContext.deleteProgram(e.program);
    }
    this._drawStateManager = { currentProgramID: null, programs: [] };
    var i = this,
      r = setInterval(function() {
        0 === i.planes.length &&
          ...
          (clearInterval(r),
          i.glContext.clear(
            i.glContext.DEPTH_BUFFER_BIT | i.glContext.COLOR_BUFFER_BIT
          ),
          i._animationFrameID &&
          ...
          i.glContext &&
            ...
            i._loseContextExtension.loseContext(),
  ...
  (Curtains.prototype._setupProgram = function(t, e, i) {
    this.glContext;
    for (var r = {}, a = 0; a < this._drawStateManager.programs.length; a++)
      this._isEqualShader(this._drawStateManager.programs[a].vsCode, t) &&
        this._isEqualShader(this._drawStateManager.programs[a].fsCode, e) &&
        (r = this._drawStateManager.programs[a]);
    return r.program ? r : this._createProgram(t, e, i);
  }),
  (Curtains.prototype._createProgram = function(t, e, i) {
    var r = this.glContext,
      a = !0,
      s = r.createProgram(),
      n = this._createShader(t, r.VERTEX_SHADER),
      o = this._createShader(e, r.FRAGMENT_SHADER);
    if (
      ((n && o) ||
        (this.productionMode ||
          console.warn(
      ...
      a &&
        ...
        this.productionMode ||
          ...
          (console.warn("Unable to initialize the shader program."), (a = !1))),
      a)
    ) {
      var h = {
      ...
      return (
        "Plane" === i &&
          ((this._drawStacks.opaque.programs["program-" + h.id] = []),
          (this._drawStacks.transparent.programs["program-" + h.id] = [])),
        this._drawStateManager.programs.push(h),
        h
      );
    }
    return a;
  ...
  (Curtains.prototype._useProgram = function(t) {
    var e = this._drawStateManager;
    (null !== e.currentProgramID && e.currentProgramID === t.id) ||
      (this.glContext.useProgram(t.program), (e.currentProgramID = t.id));
  }),
  ...
  (Curtains.prototype.removePlane = function(t) {
    ...
    for (var i = 0; i < this.planes.length; i++)
      t.index === this.planes[i].index && (e = i);
    (t = null), (this.planes[e] = null), this.planes.splice(e, 1);
    for (i = 0; i < this._drawStateManager.programs.length; i++)
      (this._drawStacks.opaque.programs[
        "program-" + this._drawStateManager.programs[i].id
      ] = []),
    ...
    for (i = 0; i < this.planes.length; i++)
      (this.planes[i].index = i), this._stackPlane(this.planes[i]);
    this.glContext &&
  ...
  (Curtains.prototype._stackPlane = function(t) {
    ...
    "transparent" === e
      ? this._drawStacks[e].programs["program-" + t._usedProgram.id].unshift(
          t.index
        )
      : this._drawStacks[e].programs["program-" + t._usedProgram.id].push(
          t.index
        ),
      this._drawStacks[e].length++;
  }),
  (Curtains.prototype._createShaderPass = function(t) {
    var e = new Curtains.ShaderPass(this, t);
    return e._usedProgram ? this.shaderPasses.push(e) : (e = !1), e;
  }),
  ...
  (Curtains.prototype.removeShaderPass = function(t) {
    ...
    for (var i = 0; i < this.shaderPasses.length; i++)
      t.index === this.shaderPasses[i].index && (e = i);
    (t = null),
  ...
  (Curtains.prototype._applyTransformationsMatrix = function(t, e, i) {
    ...
    (d[0] = a[0] + a[0]), (d[1] = a[1] + a[1]), (d[2] = a[2] + a[2]);
  ...
  (Curtains.prototype._applyMatrixToPoint = function(t, e) {
    ...
    return (
      (t[0] = (e[0] * i + e[4] * r + e[8] * a + e[12]) * s),
      (t[1] = (e[1] * i + e[5] * r + e[9] * a + e[13]) * s),
      (t[2] = (e[2] * i + e[6] * r + e[10] * a + e[14]) * s),
      t
    );
  }),
  ...
  (Curtains.prototype._drawPlaneStack = function(t) {
    for (var e in this._drawStacks[t].programs)
      for (var i = this._drawStacks[t].programs[e], r = 0; r < i.length; r++) {
        var a = this.planes[i[r]];
        a && (a._onBeforeDrawing(), a._drawPlane());
      }
  }),
  (Curtains.prototype.render = function() {
    if (
      (this._drawingEnabled || this._forceRender) &&
  ...
  (Curtains.BasePlane.prototype._initBasePlane = function(t) {
    t || (t = {}),
      ...
      (this._loadingManager = { sourcesLoaded: 0 });
    var e = this._setupShaders(t);
    if (
      ((this._usedProgram = this._wrapper._setupProgram(
        e.vertexShaderCode,
      ...
      for (var i in t.uniforms) {
        var r = t.uniforms[i];
        this.uniforms[i] = { name: r.name, type: r.type, value: r.value };
      }
    return (
      (this.userData = {}),
      !!this._usedProgram &&
    ...
    return (
      ...
      t.fragmentShader ||
        (s && document.getElementById(s)
          ? (i = document.getElementById(s).innerHTML)
          : (r.productionMode ||
              console.warn(
  ...
  (Curtains.BasePlane.prototype._setUniforms = function(t) {
    var e = this._wrapper,
      i = e.glContext;
    if ((e._useProgram(this._usedProgram), t))
      for (var r in t) {
        var a = t[r];
        (a.location = i.getUniformLocation(this._usedProgram.program, a.name)),
          a.type ||
          ...
          this._handleUniformSetting(a.type, a.location, a.value);
      }
  }),
  ...
  (Curtains.BasePlane.prototype._restoreContext = function() {
    if (
      ...
      "ShaderPass" === this._type &&
        ((this._frameBuffer = null), (this._depthBuffer = null)),
      (this._usedProgram = this._wrapper._setupProgram(
      ...
      for (var t = 0; t < this.textures.length; t++) {
        ...
        "texturePass" === this.textures[t].type
          ? this.textures[t]._initShaderPassTexture()
  ...
  (Curtains.BasePlane.prototype.getWebGLBoundingRect = function() {
    var t = this._wrapper,
      e = this._matrices.mVPMatrix;
    if (e) {
      for (
        var i = [
            t._applyMatrixToPoint([-1, 1, 0], e),
            t._applyMatrixToPoint([1, 1, 0], e),
            t._applyMatrixToPoint([1, -1, 0], e),
            t._applyMatrixToPoint([-1, -1, 0], e)
          ],
        ...
        (h[0] = (h[0] + 1) / 2),
          (h[1] = 1 - (h[1] + 1) / 2),
          h[0] < r ? (r = h[0]) : h[0] > a && (a = h[0]),
          h[1] < s ? (s = h[1]) : h[1] > n && (n = h[1]);
      }
      return {
  ...
  (Curtains.BasePlane.prototype.planeResize = function() {
    ...
    "ShaderPass" === this._type &&
      (this._wrapper.glContext.bindFramebuffer(
        this._wrapper.glContext.FRAMEBUFFER,
        this._frameBuffer
      ),
  ...
  (Curtains.BasePlane.prototype.mouseToPlaneCoords = function(t, e) {
    ...
    return {
      x:
        ((t -
          (this._boundingRect.document.left + r) / this._wrapper.pixelRatio) /
          s) *
          2 -
        1,
      y: 1 - ((e - o) / n) * 2
  ...
  (Curtains.BasePlane.prototype._drawPlane = function() {
    ...
    if (
      ...
      "ShaderPass" === this._type
        ? this.index + 1 <= t.shaderPasses.length - 1 &&
          t.shaderPasses[this.index + 1]._enableFrameBuffer()
        : (this._setPerspectiveMatrix(), this._setMVMatrix()),
      this._shouldDraw && this.visible)
    ) {
      this._updateUniforms(),
        t._drawStateManager.currentBuffersID !== this._definition.buffersID &&
          (this._bindPlaneBuffers(),
          (t._drawStateManager.currentBuffersID = this._definition.buffersID));
      for (var i = 0; i < this.textures.length; i++)
        this.textures[i]._drawTexture();
      "ShaderPass" === this._type &&
        this.index === t.shaderPasses.length - 1 &&
  ...
  (Curtains.Plane = function(t, e, i) {
    (this._type = "Plane"), Curtains.BasePlane.call(this, t, e, i);
    var r = this._wrapper;
    (this.index = r.planes.length),
      (this._canDraw = !1),
      i || (i = {}),
      this._setInitParams(i),
      this._usedProgram
        ? (r._stackPlane(this), this._initPositions(), this._initSources())
        : r._onErrorCallback && r._onErrorCallback();
  }),
  ...
  (Curtains.Plane.prototype._setInitParams = function(t) {
    ...
    t.drawCheckMargins && (i = t.drawCheckMargins),
      ...
      (this._fov = t.fov || 75),
      (this._nearPlane = 0.1),
      (this._farPlane = 2 * this._fov),
      null === t.watchScroll || void 0 === t.watchScroll
        ? (this.watchScroll = e._watchScroll)
        : (this.watchScroll = t.watchScroll || !1),
      this.watchScroll && (e._scrollManager.shouldWatch = !0),
  ...
  (Curtains.Plane.prototype._initSources = function() {
    if (this.autoloadSources) {
      ...
      for (
        ...
        r.push(this.htmlElement.getElementsByTagName("canvas")[e]);
    ...
    (a = setInterval(function() {
      s._loadingManager.sourcesLoaded >= s._loadingManager.initSourcesToLoad &&
        (clearInterval(a), s._onReadyCallback && s._onReadyCallback());
    }, 16)),
      (this._canDraw = !0),
    ...
    if (this._updatePerspectiveMatrix) {
      ...
      (this._matrices.pMatrix.matrix = [
        ...
        (this._nearPlane + this._farPlane) *
          (1 / (this._nearPlane - this._farPlane)),
        -1,
        0,
        0,
        this._nearPlane *
  ...
  (Curtains.Plane.prototype.setPerspective = function(t, e, i) {
    var r;
    (r = null === t || "number" != typeof t ? 75 : parseInt(t)) < 1
      ? (r = 1)
      : r > 180 && (r = 180),
      r !== this._fov && (this._fov = r);
    var a = parseFloat(e) || 0.1;
    a !== this._nearPlane && (this._nearPlane = a);
    var s = parseFloat(i) || 2 * r;
    s !== this._farPlane && (this._farPlane = s),
  ...
  (Curtains.Plane.prototype._setMVMatrix = function() {
    ...
    if (this._updateMVMatrix) {
      var e = {
        ...
        a = [e.x, e.y, 1];
      (this._matrices.mvMatrix.matrix = t._applyTransformationsMatrix(i, r, a)),
        (this._matrices.mVPMatrix = t._multiplyMatrix(
          this._matrices.pMatrix.matrix,
    ...
    if (
      ((t =
        null === t || "number" != typeof t
          ? 1
          : Math.max(parseFloat(t), 0.001)),
      (e =
        null === e || "number" != typeof e
          ? 1
          : Math.max(parseFloat(e), 0.001)),
  ...
  (Curtains.Plane.prototype.setRotation = function(t, e, i) {
    (t = parseFloat(t) || 0),
      ...
      (t === this.rotation.x &&
        e === this.rotation.y &&
        i === this.rotation.z) ||
        ((this.rotation = { x: t, y: e, z: i }), (this._updateMVMatrix = !0));
  }),
  ...
  (Curtains.Plane.prototype._shouldDrawCheck = function() {
    var t = this._wrapper,
      ...
      i = this;
    e.right < t._boundingRect.left - this.drawCheckMargins.right ||
    e.left >
      t._boundingRect.left +
        t._boundingRect.width +
        this.drawCheckMargins.left ||
    e.bottom < t._boundingRect.top - this.drawCheckMargins.bottom ||
    e.top >
      t._boundingRect.top + t._boundingRect.height + this.drawCheckMargins.top
      ? this._shouldDraw &&
        ((this._shouldDraw = !1),
        setTimeout(function() {
  ...
  (Curtains.Plane.prototype.updateScrollPosition = function() {
    (this._wrapper._scrollManager.lastXDelta ||
      this._wrapper._scrollManager.lastYDelta) &&
      ((this._boundingRect.document.top +=
        this._wrapper._scrollManager.lastYDelta * this._wrapper.pixelRatio),
      (this._boundingRect.document.left +=
        this._wrapper._scrollManager.lastXDelta * this._wrapper.pixelRatio),
      this._applyCSSPositions());
  }),
  ...
  (Curtains.Plane.prototype.moveToFront = function() {
    ...
    for (
      var t = this._transparent ? "transparent" : "opaque",
        e = this._wrapper._drawStacks[t].programs[
    ...
    for (var r in ("transparent" === t
      ? e.unshift(this.index)
      : e.push(this.index),
    this._wrapper._drawStacks[t]))
      r === "program-" + this._usedProgram.id &&
        delete this._wrapper._drawStacks[t][r];
    this._wrapper._drawStacks[t].programs[
      "program-" + this._usedProgram.id
    ] = e;
  }),
  (Curtains.Plane.prototype._onBeforeDrawing = function() {
    var t = this._wrapper;
    this._shouldUseDepthTest && !t._shouldHandleDepth
      ? t._handleDepth(!0)
      : !this._shouldUseDepthTest && t._shouldHandleDepth && t._handleDepth(!1);
  }),
  ...
  (Curtains.Texture = function(t, e) {
    if (
      ...
      t._usedProgram || e.isTexturePass)
    )
      return (
        ...
        (this._forceUpdate = !1),
        (this.scale = { x: 1, y: 1 }),
        e.isTexturePass ? this._initShaderPassTexture() : this._init(),
        this
      );
    this._wrapper.productionMode ||
      console.warn(
  ...
  (Curtains.Texture.prototype._init = function() {
    ...
    (this._sampler.location = t.getUniformLocation(e._usedProgram.program, i)),
    ...
    (this._textureMatrix = {
      name: r,
      matrix: null,
      location: t.getUniformLocation(this._plane._usedProgram.program, r)
    }),
  ...
  (Curtains.Texture.prototype._initShaderPassTexture = function() {
    ...
    (this.type = "texturePass"),
      ...
      (this._sampler.location = t.getUniformLocation(
        this._plane._usedProgram.program,
        this._sampler.name
      )),
      t.uniform1i(this._sampler.location, this.index),
      t.texImage2D(
  ...
  (Curtains.Texture.prototype._update = function() {
    var t = this._wrapper.glContext;
    "canvas" === this.type && t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL, !0),
      t.texImage2D(
        t.TEXTURE_2D,
        0,
        t.RGBA,
  ...
  (Curtains.Texture.prototype._getSizes = function() {
    var t = this._plane.scale ? this._plane.scale : { x: 1, y: 1 },
    ...
    return (
      n > s
        ? (h = Math.min(0, i - e * (1 / s)))
        : n < s && (o = Math.min(0, e - i * s)),
      {
        planeWidth: e,
        planeHeight: i,
        sourceWidth: r,
  ...
  (Curtains.Texture.prototype._updateTextureMatrix = function(t) {
    ...
    (this._textureMatrix.matrix = this._wrapper._scaleMatrix(i, e.x, e.y, 1)),
      this._wrapper._useProgram(this._plane._usedProgram),
      this._wrapper.glContext.uniformMatrix4fv(
  ...
  (Curtains.Texture.prototype._onSourceLoaded = function(t) {
    ...
    this._sourceLoaded ||
      setTimeout(function() {
        e._plane._onPlaneLoadingCallback && e._plane._onPlaneLoadingCallback(e);
      }, 0),
  ...
  window.addEventListener("load", function() {
    ...
    var planeElement = document.getElementsByIdName("canvas");
